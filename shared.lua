shared = {
    ...
    translations = {
        ['en'] = {
            ...
            -- Client Context Menu
            ['territory_menu_context_title'] = 'devsilvagi | Territory List',
            ...
            ['territory_info_menu_sell_title'] = 'devsilvagi | Sellable items',
            ['territory_info_menu_buy_title'] = 'devsilvagi | Buyable items',
            ['territory_info_menu_buy_sell_price'] = '💸 | Price: $%s',
            ['territory_rankings_menu_context_title'] = 'devsilvagi | Rank List',
        ...
        ['hr'] = {
            ...
            -- Client Context Menu
            ['territory_menu_context_title'] = 'devsilvagi | Popis teritorija',
            ...
            ['territory_info_menu_sell_title'] = 'devsilvagi | Prodaja item-a',
            ['territory_info_menu_buy_title'] = 'devsilvagi | Kupovina item-a',
            ['territory_info_menu_buy_sell_price'] = '💸 | Cijena: $%s',
            ['territory_rankings_menu_context_title'] = 'devsilvagi | Rank List-a',
...
function translateMessage(message)
    ...
    if not lang[message] then
        print('devsilvagi | Missing translation for: ' .. message)
        return message
    end
...
function debugPrint(msg)
    ...
    if shared.debugging.allowPrints then
        print('devsilvagi | Line: ' .. debug.getinfo(3, "Sl").currentline .. ' | \n' .. msg)
    end

    if shared.debugging.allowErrorAnalysis then
        local logHeader = 'devsilvagi | Territories Log'
        ...
        TriggerServerEvent('silvagi_territories:logAction', logHeader, logMessage)
    end
end