-- Fresh install in case this script hasn't been used previously on your server.

CREATE TABLE IF NOT EXISTS `silvagi_territories` (
...
INSERT IGNORE INTO `silvagi_territories` (`id`, `name`, `owner`, `label`, `radius`, `coords`, `type`) VALUES
